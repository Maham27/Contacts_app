    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==addperson) {
            if (resultCode == RESULT_OK) {
                ...
                String email1= data.getStringExtra("e");
                String add1= data.getStringExtra("adres");
                String num1=  data.getStringExtra("num");
                String dob1=    data.getStringExtra("d");
                friends.add(new person(name1, email1, "bhai", num1, add1, dob1));
                myadptr.notifyDataSetChanged();
